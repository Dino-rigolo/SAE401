...
<div class="container my-5">
    <h1 class="text-center fw-bold mb-4"><?php echo htmlspecialchars($store['store_name'] ?? 'Détails de la boutique'); ?></h1>
    
    <?php if (empty($store)): ?>
        <div class="alert alert-danger">
            Impossible de récupérer les informations de cette boutique.
        </div>
    <?php else: ?>
        <div class="card shadow-sm p-4 bg-light mb-4">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
                ...
                <a href="tel:<?php echo htmlspecialchars($store['phone'] ?? ''); ?>" class="text-decoration-none">
                    <?php echo htmlspecialchars($store['phone'] ?? 'Non renseigné'); ?>
                </a>
            </div>
            <div class="d-flex align-items-center mb-2">
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="mailto:<?php echo htmlspecialchars($store['email'] ?? ''); ?>" class="text-decoration-none">
                    <?php echo htmlspecialchars($store['email'] ?? 'Non renseigné'); ?>
                </a>
            </div>
        </div>
        <div class="card shadow-sm p-4 bg-light mb-4">
